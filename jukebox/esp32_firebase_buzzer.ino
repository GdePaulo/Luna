...
void setup()
{
    ...
    Serial.println("Timer set to 3.5 seconds (timerDelay variable), it will take 3.5 seconds before publishing the first reading.");
}
    ...
    if ((millis() - lastTime) > timerDelay)
    {
        ...
        if (WiFi.status() == WL_CONNECTED)
        {
            if (Firebase.ready() && signupOK)
            {
                ...
                String currentSongPath = "/savieSongs/" + currentSong;
